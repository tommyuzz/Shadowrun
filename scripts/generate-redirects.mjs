...
const modules = ["actions", "adeptpowers", "attributes", "cyberdecks", "drones", "equipment", "lifestyles", "matrixinteraction", "metatypes", "priorityarray", "qualities", "rituals", "skills", "spells", "spirits", "sprites", "vehicles", "weapons"];
