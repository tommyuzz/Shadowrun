...
const modules = ["adeptpowers", "cyberdecks", "drones", "equipment", "lifestyles", "matrixinteraction", "metatypes", "qualities", "rituals", "skills", "spells", "spirits", "sprites", "vehicles", "weapons"];
